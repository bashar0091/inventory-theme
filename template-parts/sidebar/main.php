...
<aside
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="<?php echo esc_url(home_url()); ?>">
            <img src="<?php echo esc_url($white_logo); ?>" alt="Logo" />
        </a>
    ...
    <div
        ...
        <nav
            ...
            <!-- Menu Group -->
            <div>
                <h3 class="mb-4 ml-4 text-xs font-medium text-bodydark2">MENU</h3>

                <ul class="mb-6 flex flex-col gap-1.5">
                    <?php
                    require_once get_stylesheet_directory() . '/template-parts/sidebar/item-array.php';
                    if (!empty($menu_item)) {
                        foreach ($menu_item as $item) {
                            set_query_var('menu_item', $item);
                            get_template_part('template-parts/sidebar/menu-item');
                        }
                    }
                    ?>
                </ul>

...
<header
    ...
    <div
        ...
        <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
            ...
            <!-- Hamburger Toggle BTN -->
            <a class="block flex-shrink-0 lg:hidden" href="<?php echo esc_url(home_url()); ?>">
                <img src="<?php echo esc_url($logo_url); ?>" class="w_130" alt="Logo" />
            </a>
        </div>
            ...
            <div
                ...
                <a
                    ...
                    <span class="h-12 w-12 rounded-full overflow-hidden">
                        <img src="<?php echo esc_url($user_data['gravatar_url']); ?>" alt="User" />
                    </span>

...
get_header();
$img = get_stylesheet_directory_uri() . '/assets/images/illustration.svg';
?>
<div class="rounded-sm border border-stroke bg-white px-5 py-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:py-20">
    <div class="mx-auto max-w-[410px]">
        <img src="<?php echo esc_url($img); ?>" alt="illustration">
        ...
        <div class="mt-7.5 text-center">
            ...
            <a href="<?php echo esc_url(home_url()); ?>" class="mt-7.5 inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 font-medium text-white hover:bg-opacity-90">
